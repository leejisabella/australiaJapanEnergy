...
| `firb/japan_firb_approvals_by_sector.csv` | FIRB Annual Reports 2014-15 through 2020-21 ([foreigninvestment.gov.au](https://foreigninvestment.gov.au)) | Japan's proposed-investment approvals by industry sector. 6 fiscal years from individually downloaded FIRB Annual Report PDFs (Table 3.17 / 3.14 / 4.13 / 2.12 depending on year). Parsed via `scripts/parse_firb.py`. Caveat: these are *proposed* approvals not realized FDI — typically 1–5x larger than actual capital deployed. |
